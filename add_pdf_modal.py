...
# Inject Modal HTML right before SCRIPTS section
if 'id="pdf-filial-modal"' not in text:
    text = text.replace('<!-- ========================================== -->\r\n    <!-- SCRIPTS -->', modal_html + '\r\n    <!-- ========================================== -->\r\n    <!-- SCRIPTS -->')
    text = text.replace('<!-- ========================================== -->\n    <!-- SCRIPTS -->', modal_html + '\n    <!-- ========================================== -->\n    <!-- SCRIPTS -->')

# Change the onClick of the Export PDF button
text = text.replace('onclick="exportTrainingsToPDF()"', 'onclick="openExportPDFModal()"')
